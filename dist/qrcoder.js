...
function createStringToBytes(unicodeData, numChars) {
  ...
  const unicodeMap = function () {
    let bin = new Base64DecodeInputStream(unicodeData);
    const read = function () {
      let b = bin.read();
...
function QRCoder(options) {
  ...
  const typeNumber = this._options.typeNumber || this.calcTypeNumber(this._options.data, errorCorrectionLevel, this._options.mode) || 4;
...
QRCoder.prototype = {
  ...
  calcSpec: function () {
    ...
    if (!this._options.cellSize && !this._options.margin && this._options.size) {
      ...
      cellSize = cellSize || this._options.cellSize || 2, margin = margin || this._options.margin || cellSize * 4;
    }
...
//# sourceMappingURL=qrcoder.js.map
