...
QRPolynomial.prototype = {
  ...
  mod: function mod(e) {
    ...
    for (var _i = 0; _i < e.getLength(); _i += 1) {
      num[_i] ^= QRMath.gexp(QRMath.glog(e.getAt(_i)) + ratio);
    }
...
function QRKanji(data) {
  ...
  !function (c, code) {
    ...
    var test = stringToBytesFuncs['default'](c);
...
for (var i$1 = 0; i$1 < types.length; i$1++) {
  class2type['[object ' + types[i$1] + ']'] = types[i$1].toLowerCase();
}
